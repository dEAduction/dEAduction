...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 15 07:44:24 2020
...
TODO
(1) variables muettes : à quel niveau le faire
(2) META-APPLI, LOCAL CST, etc: avoir un nom invariable et passer pp et
...
class PropObj:
    ...
    latex_rep: str                  # changer en dict[str] keys = fr, en
    ...
    def print_PO(self, inc = 0):    # representation as a tree - for debug
...
#def create_PO(prop_obj_str:str):
...
def create_anPO(PO_dict: dict,  bound_vars_list, debug): 
    """
...
##### treatment of bound variables
    if nature in ["QUANT_∀", "QUANT_∃"]:
        ...
        print(f"erreur : local const, ident =  {ident}")
####
...
#### creation of children PO    
    ...
    if nature != "PROP_IMPLIES":
        for arg in arguments:
            arg_PO = create_anPO(arg, bound_vars_list, debug)
            args.append(arg_PO)
