...
class UserProofAction(UserAction):
    ...
    button_name should be left to default value "apply" when a statement is
    called. Thus there are two main ways to create a UserProofAction:
