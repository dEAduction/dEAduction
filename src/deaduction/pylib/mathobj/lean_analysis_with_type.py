...
if __name__ == "__main__":
    ...
    trials = ["""¿¿¿object: LOCAL_CONSTANT¿[name: X¿/ identifier: 0._fresh.833.4471¿]¿= TYPE""",
"""¿¿¿object: LOCAL_CONSTANT¿[name: Y¿/ identifier: 0._fresh.833.4473¿]¿= TYPE""",
"""¿¿¿object: LOCAL_CONSTANT¿[name: Z¿/ identifier: 0._fresh.833.4475¿]¿= TYPE""",
"""¿¿¿object: LOCAL_CONSTANT¿[name: f¿/ identifier: 0._fresh.833.4477¿]¿= FUNCTION¿(LOCAL_CONSTANT¿[name: X¿/ identifier: 0._fresh.833.4471¿]¿, LOCAL_CONSTANT¿[name: Y¿/ identifier: 0._fresh.833.4473¿]¿)""",
"""¿¿¿object: LOCAL_CONSTANT¿[name: g¿/ identifier: 0._fresh.833.4479¿]¿= FUNCTION¿(LOCAL_CONSTANT¿[name: Y¿/ identifier: 0._fresh.833.4473¿]¿, LOCAL_CONSTANT¿[name: Z¿/ identifier: 0._fresh.833.4475¿]¿)""",
"""¿¿¿property¿[pp_type: surjective f¿]: LOCAL_CONSTANT¿[name: H1¿/ identifier: 0._fresh.833.4487¿]¿= APPLICATION¿[type: PROP¿]¿(APPLICATION¿[type: FUNCTION¿(FUNCTION¿(LOCAL_CONSTANT¿[name: X¿/ identifier: 0._fresh.833.4471¿]¿, LOCAL_CONSTANT¿[name: Y¿/ identifier: 0._fresh.833.4473¿]¿)¿, PROP¿)¿]¿(APPLICATION¿[type: QUANT_∀¿(TYPE¿, LOCAL_CONSTANT¿[name: Y¿/ identifier: _fresh.830.7364¿]¿, FUNCTION¿(FUNCTION¿(LOCAL_CONSTANT¿[name: X¿/ identifier: 0._fresh.833.4471¿]¿, LOCAL_CONSTANT¿[name: Y¿/ identifier: _fresh.830.7364¿]¿)¿, PROP¿)¿)¿]¿(CONSTANT¿[name: surjective¿]¿[type: QUANT_∀¿(TYPE¿, LOCAL_CONSTANT¿[name: X¿/ identifier: _fresh.830.7391¿]¿, QUANT_∀¿(TYPE¿, LOCAL_CONSTANT¿[name: Y¿/ identifier: _fresh.830.7403¿]¿, FUNCTION¿(FUNCTION¿(LOCAL_CONSTANT¿[name: X¿/ identifier: _fresh.830.7391¿]¿, LOCAL_CONSTANT¿[name: Y¿/ identifier: _fresh.830.7403¿]¿)¿, PROP¿)¿)¿)¿]¿, LOCAL_CONSTANT¿[name: X¿/ identifier: 0._fresh.833.4471¿]¿)¿, LOCAL_CONSTANT¿[name: Y¿/ identifier: 0._fresh.833.4473¿]¿)¿, LOCAL_CONSTANT¿[name: f¿/ identifier: 0._fresh.833.4477¿]¿)""",
"""¿¿¿property¿[pp_type: surjective g¿]: LOCAL_CONSTANT¿[name: H2¿/ identifier: 0._fresh.833.4496¿]¿= APPLICATION¿[type: PROP¿]¿(APPLICATION¿[type: FUNCTION¿(FUNCTION¿(LOCAL_CONSTANT¿[name: Y¿/ identifier: 0._fresh.833.4473¿]¿, LOCAL_CONSTANT¿[name: Z¿/ identifier: 0._fresh.833.4475¿]¿)¿, PROP¿)¿]¿(APPLICATION¿[type: QUANT_∀¿(TYPE¿, LOCAL_CONSTANT¿[name: Y¿/ identifier: _fresh.830.7438¿]¿, FUNCTION¿(FUNCTION¿(LOCAL_CONSTANT¿[name: Y¿/ identifier: 0._fresh.833.4473¿]¿, LOCAL_CONSTANT¿[name: Y¿/ identifier: _fresh.830.7438¿]¿)¿, PROP¿)¿)¿]¿(CONSTANT¿[name: surjective¿]¿[type: QUANT_∀¿(TYPE¿, LOCAL_CONSTANT¿[name: X¿/ identifier: _fresh.830.7465¿]¿, QUANT_∀¿(TYPE¿, LOCAL_CONSTANT¿[name: Y¿/ identifier: _fresh.830.7477¿]¿, FUNCTION¿(FUNCTION¿(LOCAL_CONSTANT¿[name: X¿/ identifier: _fresh.830.7465¿]¿, LOCAL_CONSTANT¿[name: Y¿/ identifier: _fresh.830.7477¿]¿)¿, PROP¿)¿)¿)¿]¿, LOCAL_CONSTANT¿[name: Y¿/ identifier: 0._fresh.833.4473¿]¿)¿, LOCAL_CONSTANT¿[name: Z¿/ identifier: 0._fresh.833.4475¿]¿)¿, LOCAL_CONSTANT¿[name: g¿/ identifier: 0._fresh.833.4479¿]¿)""",
"""¿¿¿object: LOCAL_CONSTANT¿[name: y¿/ identifier: 0._fresh.830.7325¿]¿= LOCAL_CONSTANT¿[name: Z¿/ identifier: 0._fresh.833.4475¿]""",
"""¿¿¿property¿[pp_type: ∃ (x : Y), g x = y¿]: LOCAL_CONSTANT¿[name: H3¿/ identifier: 0._fresh.830.7332¿]¿= QUANT_∃¿[type: PROP¿]¿(LOCAL_CONSTANT¿[name: Y¿/ identifier: 0._fresh.833.4473¿]¿, LOCAL_CONSTANT¿[name: x¿/ identifier: _fresh.830.7488¿]¿, PROP_EQUAL¿[type: PROP¿]¿(APPLICATION¿[type: LOCAL_CONSTANT¿[name: Z¿/ identifier: 0._fresh.833.4475¿]¿]¿(LOCAL_CONSTANT¿[name: g¿/ identifier: 0._fresh.833.4479¿]¿, LOCAL_CONSTANT¿[name: x¿/ identifier: _fresh.830.7488¿]¿)¿, LOCAL_CONSTANT¿[name: y¿/ identifier: 0._fresh.830.7325¿]¿)¿)"""
    ]
    math_objects = []
    for trial in trials:
    ...
    for math_object in math_objects:
        ...
        display_mo.append(display)
        print(display)

    display_mot = []
    for math_object in math_objects:
        display = display_math_object(math_object.math_type, "utf8")
        display_mot.append(display)
        print(display)