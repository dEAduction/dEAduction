...
def give_name0(goal, math_type: PropObj, hints: List[str] = []) -> str:
    """
...
def instantiate_bound_var(math_type, name):
...
def give_name(goal, math_type: PropObj, hints: List[str] = []) -> str:
    """
